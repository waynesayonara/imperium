...
module Imperium
  module DataModels
    class MenuSceneDataModelFactory
      ...
      private
      def self.create_resume_game_element_data_model(offset)
      ...
      private
      def self.create_new_game_element_data_model(offset)
        area = create_menu_element_area(offset)
        image_normal = Gosu::Image.new($window, '../resources/menu/new_game.png', false)
        image_active = Gosu::Image.new($window, '../resources/menu/new_game_selected.png', false)
      ...
      private
      def self.create_load_game_element_data_model(offset)
        area = create_menu_element_area(offset)
      ...
      private
      def self.create_exit_game_element_data_model(offset)
        area = create_menu_element_area(offset)
      ...
      private
      def self.create_menu_element_area(offset)
