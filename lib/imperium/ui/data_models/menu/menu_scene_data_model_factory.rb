  ...
  module DataModels
    class MenuSceneDataModelFactory
      ...
      def self.create_start_menu_data_model
        ...
        return Imperium::DataModels::MenuSceneDataModel.new(background, menu_elements)
      end
      ...
      def self.create_new_game_element_data_model
        area = Imperium::Area.new(Imperium::Point.new(MENU_ELEMENTS_X_MARGIN, MENU_ELEMENTS_Y_MARGIN), 464, 95)
        ...
        action = lambda { $window.push_scene(Imperium::GameScene.new(Imperium::Game.load_game_from_map(Imperium::Map::TEST_PATH))) }
      ...
      def self.create_load_game_element_data_model
        area = Imperium::Area.new(Imperium::Point.new(MENU_ELEMENTS_X_MARGIN, MENU_ELEMENTS_Y_MARGIN + 150), 464, 95)
      ...
      def self.create_exit_game_element_data_model
        area = Imperium::Area.new(Imperium::Point.new(MENU_ELEMENTS_X_MARGIN, MENU_ELEMENTS_Y_MARGIN + 300), 464, 95)
